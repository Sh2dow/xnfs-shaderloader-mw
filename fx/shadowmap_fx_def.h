...
/////////////////////////////////////////////////////////////////////////////////////////
static const float kShadowMapFallOff = 0.85f;
...
{
	// D3D9 fallback: offset in texel space scaled by shadow map size.
	return tex2D( ss, uv + offset * float2(g_fShadowMapScaleX, g_fShadowMapScaleY) );
}
